/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7a5d82822105525f46e3f5011421be92)
// Runtime types generated with workerd@1.20260911.1 2026-09-11 nodejs_compat
interface __BaseEnv_Env {
	R2: R2Bucket;
	DB: D1Database;
	WEB_ORIGINS: "http://localhost:8081,http://127.0.0.1:8081,http://localhost:8088,http://127.0.0.1:8088";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "WEB_ORIGINS" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL">> {}
}
